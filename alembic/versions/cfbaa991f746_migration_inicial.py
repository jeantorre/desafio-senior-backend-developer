...
Revision ID: cfbaa991f746
Revises:
Create Date: 2025-05-09 00:00:58.528749
...
def upgrade() -> None:
    ...
    op.drop_table("dim_tipo_transacao")
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("tipo_transacao_id", name="dim_tipo_transacao_pkey"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["tipo_transacao_id"],
            ["dim_tipo_transacao.tipo_transacao_id"],
            name="fat_transacao_carteira_tipo_transacao_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["usuario_id"],
